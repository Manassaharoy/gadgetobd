...
def payment(request):
    ...
    val_id = ( ''.join(random.choice(letters) for i in range(10)) )
    tran_id = ( ''.join(random.choice(letters) for i in range(10)) )
    ...
    # store_id = 'gadge6267bb7632e5b'
    # API_key = 'gadge6267bb7632e5b@ssl'
